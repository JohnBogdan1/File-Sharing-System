                ...
                if (!name.toLowerCase().equals(ADMIN)) {
                    ...
                    if (line.toLowerCase().contains("upload")) {
                        ...
                        for (int i = 0; i < comm.length; i++) {
                            ...
                            File file = new File("Client" + File.separator + name + File.separator + filename);
                            // System.out.println("Client" + File.separator + name + File.separator + filename);
                        ...
                        switch (response) {
                            case "foundFile":
                                userFile = new UserFile(is.readLine(),
                        ...
                        if (userFile != null && userFile.isOnline) {
                            //System.out.println("PORTUL:" + userFile.port);
